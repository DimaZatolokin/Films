...
public class FilmsDao {
    ...
    static String obtainCreateInstancesQuery() {
        return "CREATE TABLE IF NOT EXISTS '" + TABLE_NAME + "' ('" + COLUMN_ID + "' INTEGER PRIMARY KEY, '" + COLUMN_TITLE + "' TEXT NOT NULL UNIQUE ON CONFLICT REPLACE, " +
                "'" + COLUMN_IMAGE + "' TEXT, '" + COLUMN_RATING + "' REAL, '" + COLUMN_RELEASE_YEAR + "' INTEGER, '" + COLUMN_GENRE + "' TEXT)";
    }
